...
var uBeginUp=straightLen+0.2*arcLen; // !! also change in updateDimensions
var uEndUp=straightLen+1.0*arcLen;
...
//#################################################################
  ...
  updateInflow(time);
  var newBanStatus=controlOvertakingBan(network[0].veh, time); 
...
//##################################################
  ...
  if(backgroundJustDrawn||banButtonClicked){ // MT 2020-01
    ...
    var xPixBan=mainroad.get_xPix(uBeginBan,-vOffset);
    var yPixBan=mainroad.get_yPix(uBeginBan,-vOffset);
    var xPixEndBan=mainroad.get_xPix(uEndBan,-vOffset);
    var yPixEndBan=mainroad.get_yPix(uEndBan,-vOffset);
