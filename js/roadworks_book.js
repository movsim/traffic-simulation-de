...
// determines general aspect ratio of simulated network
var critAspectRatio=125./95.; // from css file width/height of #contents
var critAspectRatio=105./95.; // book
...
detectors[1]=new stationaryDetector(mainroad,0.80*mainroadLen,30);
...
var trafficObjs=new TrafficObjects(canvas,0,3,0.60,0.50,1,3); //book
...
var speedl=trafficObjs.trafficObj[0]; // .value => speedlimit 80 in km/h

// sets speedl.value and selects new image (only trafficObjs method available)
trafficObjs.setSpeedLimit(0,80);
...
//##################################################
  ...
  var relTextsize_vmin=0.026; //book
