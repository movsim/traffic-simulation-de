...
var rDev=15;                       // radius of curves on deviation route
var alpha=0.2*Math.PI;             // heading change of first right-curve
var lrampDev=75;            // length of off/onramp section of deviation
var taperLen=7;                    // for both merge/diverge parts
var lParallel=30;                // length parallel to mainroad before merg.
...
//##################################################
    ...
    if(hasChanged){
      ...
      center_yPhys=-1.43*arcRadius; // ypixel downwards=> physical center <0
...
*/
    ...
    deviation.drawVehicles(carImg,truckImg,obstacleImg,scale,vmin_col,vmax_col);
