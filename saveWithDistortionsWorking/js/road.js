...
function road(roadID,roadLen,laneWidth,nLanes,traj_x,traj_y,
  ...
  // end define transform functions if doGridding
...
road.prototype.gridTrajectories=function(traj_xExt, traj_yExt){
  ...
  this.testArray=[this.traj_x,this.traj_y];
  console.log("this.traj_x=",this.traj_x);
  console.log(" this.testArray[0]=",this.testArray[0]);
  //console.log(" this.testArray[0](10)=",this.testArray[0](10));
  ...
  if(this.roadID==1){
		...
		//" this.testArray[0](0)=",this.testArray[0](0),
